var Vayu = function () {
    ...
    var setupRoutes = function() {
        ...
        //not sure if this is the best way to so analytics
        var analytics = {
            token: _app.get('conf').get('VAYU_GA_TOKEN'),
            domain: _app.get('conf').get('VAYU_GA_DOMAIN')
        }
    ...
    var cardsDeleteHandler = function(req, res) {
        deleteCard(req.user._id, req.params.id, function(card) {
            res.json(200, "200");
        }, function(err) {
            res.send(500);
        });
    ...
    var updateCard = function(userId, id, lid, name, dodos, success, fail) {
        _card.updateCard(userId, id, lid, name, dodos, success, fail);
    }
