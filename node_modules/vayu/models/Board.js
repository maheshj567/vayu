...
p.getMemories = function (personId, visibility, success, fail)
{
...
p.addMemory = function (personId, msg, type, data, gallery, links, tagged, visibility, location, success, fail)
{
    ...
    var m = new this.Model({
        ...
        ty: type,
        d: data,
        g: gallery == null ? [] : gallery,
        l: links == null ? [] : links,
        v: visibility,
        loc: location,
        t: tagged == null ? [] : tagged
    });
    this.saveModel(m, success, fail);
}
...
board.init('Board', 'board', {
    //user id
    u: { type: mem.Schema.ObjectId, ref: "User" },
    //name
    n: String,
    //created date
