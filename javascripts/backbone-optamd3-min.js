...
(function(a, b) {
	...
	b.VERSION = "0.5.3", b.noConflict = function() {
		...
		a || ( a = {});
		if ( d = this.defaults)
			c.isFunction(d) && ( d = d.call(this)), a = c.extend({}, d, a);
		...
		set : function(a, b) {
			...
			for (var g in a) {
				var h = a[g];
				c.isEqual(d[g], h) || (d[g] = h,
				delete e[g], this._changed = !0, b.silent || this.trigger("change:" + g, this, h, b))
			}
		...
		unset : function(a, b) {
			if ( a in this.attributes) {
				...
				return d[a] =
				void 0, !b.silent && this.validate && !this._performValidation(d, b) ? !1 : ((this._unsetAttributes || (this._unsetAttributes = [])).push(a),
				delete this.attributes[a],
				delete this._escapedAttributes[a], a == this.idAttribute &&
				delete this.id, this._changed = !0, b.silent || (this.trigger("change:" + a, this,
				void 0, b), this.change(b)), this)
			}
			return this
		},
		clear : function(a) {
		...
		_removeReference : function(a) {
			this == a.collection &&
			delete a.collection, a.unbind("all", this._onModelEvent)
		},
		_onModelEvent : function(a, b, c, d) {
			if (a != "add" && a != "remove" || c == this)
				a == "destroy" && this._remove(b, d), b && a === "change:" + b.idAttribute && (
				delete this._byId[b.previous(b.idAttribute)], this._byId[b.id] = b), this.trigger.apply(this, arguments);
			else
				return
		}
	});
	...
	c.extend(b.View.prototype, b.Events, {
		...
		_ensureElement : function() {
			if (!this.el) {
				...
				c.isString(this.el) && (this.el = d(this.el).get(0))
		}
	});
	var q = function(a, b) {
		var c = t(this, a, b);
	...
	b.sync = function(a, e, f) {
		...
		return f.url || (h.url = u(e) || v()), !f.data && e && (a == "create" || a == "update") && (h.contentType = "application/json", h.data = JSON.stringify(e.toJSON())), b.emulateJSON && (h.contentType = "application/x-www-form-urlencoded", h.data = h.data ? {
			model : h.data
